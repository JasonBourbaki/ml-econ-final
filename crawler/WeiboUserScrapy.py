# -*- coding: utf-8-sig -*-
# Author: Tao Xiao
# Github repository: https://github.com/Python3Spiders/WeiboSuperSpider
...
Cookie = "_T_WM=a427147c52b5f1170518bb2f128af2ca; SCF=AhG9BMPSCyjeLOY39PAl3TgjMAfaYYe31XPoSCtTZWJ6mbFu-Q1xuQYPhzBwvZvA0tO29df4wxZO8g86e-kXYtg.; SUB=_2A25LPDUsDeRhGedK6VIZ8ijLzTiIHXVoMMjkrDV6PUJbktANLUr5kW1NJ2e2_FgmJJzbxuWpe7W-PTB7rFkiAtBZ; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9W5_S4aa3-gs-02KxoQpEcBG5NHD95QpShz71hzcS0qXWs4Dqcjgi--fi-ihiKn7i--fi-isiKn0wsfjd7tt; SSOLoginState=1714963837; ALF=1717555837; MLOGIN=1; M_WEIBOCN_PARAMS=luicode%3D20000174"
        ...
        try:
            ...
            if (not self.filter) or is_original:
                ...
                weibo['content'] = self.get_weibo_content(info,
                                                          is_original)  # 微博内容
                picture_urls = ""
                weibo['original_pictures'] = ""  # 原创图片url
                if not self.filter:
                    weibo['retweet_pictures'] = ""  # 转发图片url
                    weibo['original'] = is_original  # 是否原创微博
                weibo['publish_place'] = ''  # 微博发布位置
                weibo['publish_time'] = self.get_publish_time(info)  # 微博发布时间
                weibo['publish_tool'] = ''  # 微博发布工具
...
if __name__ == '__main__':
    ...
    WeiboUserScrapy(user_id=2803301701, filter=1, download_img=False)
